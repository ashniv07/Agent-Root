...
export function InsightsDashboard({ refreshTrigger = 0 }: InsightsDashboardProps) {
  ...
  if (loading || !stats) {
    return (
      <div className="grid gap-4 lg:grid-cols-2">
        <div className="h-56 animate-pulse rounded-2xl border border-slate-700 bg-slate-900/60" />
        <div className="h-56 animate-pulse rounded-2xl border border-slate-700 bg-slate-900/60" />
      </div>
    );
  }
